...
public interface CourseMapper {
    ...
    @Results({
            ...
            @Result(property = "teacher", column = "course_id", many = @Many(select = "com.backend.blogfrontbackend.mapper.TeacherMapper.findTeacherByCourseId")),
    ...
    @Results({
            ...
            @Result(property = "courseDescription", column = "course_description"),
            @Result(property = "coursePrice", column = "course_price"),
            @Result(property = "teacher", column = "teacher_id", one = @One(select = "com.backend.blogfrontbackend.mapper.TeacherMapper.findTeacherById")),
            @Result(property = "onlineStatus", column = "online_status"),
