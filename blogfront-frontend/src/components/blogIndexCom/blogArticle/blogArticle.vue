        ...
        <div class="position-sticky" style="top: 2rem;">
          ...
          <div class="p-4">
            ...
            <ol class="list-unstyled mb-0">
              ...
              <li><a @click="gotoblogArticleManagement()" class="nav-item" style="cursor:pointer">管理博客</a></li>
<!--              <li><a @click="gotoblogCommentMangement()" class="nav-item" style="cursor:pointer">管理评论</a></li>-->
            </ol>
          </div>
...
const gotoblogArticleManagement = () =>{
  if(store.auth.userInfo === null){
    alert("请先登录博客！")
    router.push("/login")
  }else{
...
const gotoblogCommentMangement = () => {
  if(store.auth.userInfor === null){
    alert("请先登录博客！")
    router.push("/login")
  }else{
    router.push("/commentManagement")
  }
}
...
.div1{
  margin-top: -50px;
  background: url("@/assets/img/blog-article/article01.png");
}
.div2{
  margin-top: -50px;
}
